...
export default function Movies(props) {
  ...
  const ListBegin = allMovies[0] ? 1 : 0;
  ...
  return (
    <>
      ...
      {query?null:allMovies?.length > 0 && allMovies[0] && (
        <Box
          component={Link}
        ...
        >
          ...
          >
            <CardMedia
              media="picture"
              image={`https://image.tmdb.org/t/p/original/${allMovies[0]?.backdrop_path}`}
              // title={movie.title}
              sx={{
                position: "absolute",
                top: 0,
            ...
            <Box>
              ...
              >
                ...
                <Typography variant="body1">{allMovies[0].overview}</Typography>
              </CardContent>
            </Box>
          </Card>
        </Box>
